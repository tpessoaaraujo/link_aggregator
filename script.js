...
function exibirCitacao() {
    const citacoes = [
        ...
        "\"Você é mais valente do que acredita, mais forte do que parece, e mais inteligente do que pensa.\" — Alvo Dumbledore",
        ...
        "\"Não faço ideia do que aconteceu entre vocês, mas fiquei surpreso ao ver que vocês dois se separaram.\" — Minerva McGonagall",
